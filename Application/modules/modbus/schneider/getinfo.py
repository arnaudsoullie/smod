...
class Module:
	...
	info = {
		...
		'Description': ("Get information (Hardware, software, project) from a Schneider PLC"),
	...
	def do(self,ip):
		...
		if ans:
			...
			if returnCode > 127 and exceptionCode == 0x01:
				...
				self.printLine("[-] Function Code 90 is not supported.",bcolors.FAIL)
				a=1
			else:
			...
			self.printLine("[-] No response received for Function Code 90",bcolors.FAIL)
